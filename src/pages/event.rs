...
pub fn event(_props: &Props) -> Html {
    let images = vec![
                ...
                <div class="tile">
                    ...
                    <div class="tile is-parent">
                        <figure class="tile is-child image">
                            ...
                            <img alt="The event's theme picture." src={"/static/events/imports/jpg/image_1.jpg"} />
                        </figure>
                    </div>
                </div>
                // Container for the image carousel section with Bulma and custom styling
                <div class={"tile is-parent event-carousel-container"}>
                    // Title for the carousel
                    <div class={"carousel-title has-text-centered"}>
                        <p class={"title has-text-info"}>{"Highlights from Our Past Event"}</p>
                    </div>
                    <div class="tile is-parent">
                        <figure class="tile is-child image">
                            <Carousel images={images} />
                    ...
                    <div class="tile is-parent">
                        <article class="tile is-child notification is-white">
                            <div class="content">
                                ...
                                <p class="title has-text-info">{"Event Announcement"}</p>
